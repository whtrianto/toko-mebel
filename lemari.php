    ...
    <section id="pricing">
        <div class="container-fluid pt-5 pb-3">
            <div class="container">
                ...
                <h1 class="display-4 text-center mb-5">Lemari Pakaian</h1>
                <div class="row1">
                    <?php
                    require('config.php');
                    $sql    = "SELECT * FROM produk_lemari";
                    ...
                    ?>
                        <div class="col-md-4 text-center animate-box">
                            <div class="product">
                                <div class="product-grid" style="background-image:url(images/lemari/<?php echo $data["gambar"]; ?>);">
