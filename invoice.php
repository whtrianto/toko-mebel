...
<h1 class="h3 mb-2">
    ...
    <span class="float-right">
        <a href="laporan.php" class="btn btn-info btn-sm px-3 mr-1">Kembali ke Laporan</a>
        <a href="transaksi.php" class="btn btn-success btn-sm px-3 mr-1">Kembali ke Transaksi</a>
        <button type="button" class="btn btn-warning btn-sm px-3" onclick="document.title='Invoice#<?php echo $noinv ?>';window.print()">
            Cetak</button>
    </span>
</h1>
<div class="bg-purple p-2 text-white bg-primary" style="border-radius:0.25rem;">
    <div class="row">
        <div class="col-lg-6">
...
<div class="row justify-content-end mt-1">
    ...
    <div class="col-sm-6 col-md-5 col-lg-4">
        <div class="bg-purple text-white p-2 bg-primary">
    ...
    <div class="d-none pt-5 px-5 print-show">
        ...
        <div class="row">
            ...
            <div class="col-12 text-center mt-5">
                <h2>* Terima Kasih Telah Berbelanja Di Toko X *</h2>
            </div>
        </div><!-- end row -->
    </div><!-- end box print -->
</section>
