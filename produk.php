  ...
  <tbody>
    ...
    ?>
      <tr class="text-center">
        ...
        <td class="align-middle"><img src="images/rekomen/<?= $d['gambar']; ?>" width="100"></td>
        <td class="align-middle text-left"><?php echo $d['nama_produk']; ?></td>
        <td class="align-middle">Rp.<?php echo ribuan($d['harga_normal']); ?></td>
            ...
            <form method="post" enctype="multipart/form-data">
              ...
              <div class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <img src="images/rekomen/<?= $d['gambar']; ?>" width="100"> <br>
                ...
                <div class="form-group">
                  <label class="samll">Harga Normal :</label>
                  <input type="number" placeholder="0" name="Edit_Harga_Normal" value="<?php echo $d['harga_normal']; ?>" class="form-control" required>
                </div>
                <div class="form-group">
...
if (isset($_POST['TambahProduk'])) {
  ...
  $harga_normal = htmlspecialchars($_POST['Tambah_Harga_Normal']);
  ...
  if ($cekkode > 0) {
    ...
    $InputProduk = mysqli_query($conn, "INSERT INTO produk (kode_produk,gambar,nama_produk,harga_normal,harga_jual,stok)
     values ('$kodeproduk','$gambar','$nama_produk','$harga_normal','$harga_jual','$stok')");
    if ($InputProduk) {
...
if (isset($_POST['SimpanEdit'])) {
  ...
  $harga_normal1 = htmlspecialchars($_POST['Edit_Harga_Normal']);
  ...
  if ($HasilData > 0) {
    ...
    $cekDataUpdate =  mysqli_query($conn, "UPDATE produk SET kode_produk='$kodeproduk1',
        gambar='$gambar1',nama_produk='$nama_produk1',harga_normal='$harga_normal1',harga_jual='$harga_jual1',stok='$stok1'
...
function upload()
{
  ...
  move_uploaded_file($tmpName, 'images/rekomen/' . $namaFileBaru);
  return $namaFileBaru;
}
...
<div class="modal fade" id="TambahProduk" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content border-0">
      ...
      $sql = mysqli_query($conn, "select max(kode_produk) as maxID from produk");
      ...
      <form method="post" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label class="samll">Harga Normal :</label>
            <input type="number" placeholder="0" name="Tambah_Harga_Normal" class="form-control" required>
          </div>
          <div class="form-group">
            <label class="samll">Harga Jual :</label>
