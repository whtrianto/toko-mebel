    ...
    <section id="pricing">
        <div class="container-fluid pt-5 pb-3">
            <div class="container">
                ...
                <h1 class="display-4 text-center mb-5">Rak TV</h1>
                <div class="row1">
                    <?php
                    require('config.php');
                    $sql    = "SELECT * FROM produk_rak_tv";
                    ...
                    ?>
                        <div class="col-md-4 text-center animate-box">
                            <div class="product">
                                <div class="product-grid" style="background-image:url(images/rak_tv/<?php echo $data["gambar"]; ?>);">
