...
?>
<br>
<h1 class="h3 mb-2">Data Riwayat Belanja</h1>
<div class="row">

  <div class="col-6 col-sm-6 col-md-3 col-lg-3 m-pr-1 m-mb-1">
    <div class="box-laporan bg-info">
      <p class="small mb-0">Barang Terjual:</p>
  ...
  <div class="col-6 col-sm-6 col-md-3 col-lg-3 m-pl-1">
    <div class="box-laporan bg-success">
      <p class="small mb-0">Total Uang:</p>
        ...
        <td>
          <form method="post">
            ...
            <button type="submit" name="Remove" class="btn btn-danger btn-sm">
              ...
              <a href="invoice.php?detail=<?php echo $oninv ?>">
                <div  class="btn btn-info btn-sm">
                  <i class="fas fa-trash-alt fa-xs mr-1"></i>Lihat</div>
                </a>
          </form>
        </td>
      </tr>
