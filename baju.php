                    ...
                    <div class="d-inline-flex align-items-center">
                        <a href="index.php">
                            <h1 class="m-0 text-secondary">
                                <span class="text-light">Toko</span>Evas
                            </h1>
                        </a>
                    </div>
                </div>
    ...
    <section id="pricing">
        <div class="container-fluid pt-5 pb-3">
            <div class="container">
                ...
                <h1 class="display-4 text-center mb-5">Pakaian</h1>
                <div class="row1">
                    <?php
                    require('config.php');
                    $sql    = "SELECT * FROM produk_baju";
                    $query  = mysqli_query($conn, $sql);
                    while ($data = mysqli_fetch_array($query)) {
                    ?>
                        <div class="col-md-4 text-center animate-box">
                            <div class="product">
                                <div class="product-grid" style="background-image:url(images/baju/<?php echo $data["gambar"]; ?>);">
